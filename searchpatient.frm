...
Begin VB.Form searchpatient 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "searchpatient.frx":0000
      Height          =   6255
      Left            =   120
      TabIndex        =   4
      Top             =   3120
   ...
   End
End
Attribute VB_Name = "searchpatient"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command2_Click()
Adodc1.RecordSource = "Select * From patient"
Adodc1.Refresh
End Sub
...
Adodc1.RecordSource = "Select * From patient Where ID=" + Text1.Text + ""
Adodc1.Refresh
