...
Begin VB.Form searchdoctor 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "searchdoctor.frx":0000
      Height          =   6255
      Left            =   120
      TabIndex        =   4
      Top             =   2760
   ...
   End
End
Attribute VB_Name = "searchdoctor"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command2_Click()
Adodc1.RecordSource = "Select * From doctor"
Adodc1.Refresh
End Sub
...
Adodc1.RecordSource = "Select * From doctor Where ID=" + Text1.Text + ""
Adodc1.Refresh
