...
Begin VB.Form addstaff 
   ...
   Begin VB.Image imgLogo 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "addstaff.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11895
   End
End
Attribute VB_Name = "addstaff"
...
Adodc1.Recordset.Fields("sadd") = Text3.Text
Adodc1.Recordset.Fields("smob") = Text4.Text
Adodc1.Recordset.Fields("squali") = Text5.Text
Adodc1.Recordset.Fields("jdate") = Text6.Text
Adodc1.Recordset.Fields("payment") = Text7.Text
