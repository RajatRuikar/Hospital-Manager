...
Begin VB.Form searchpathology 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "searchpathology.frx":0000
      Height          =   6255
      Left            =   120
      TabIndex        =   4
      Top             =   3000
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "Select *  From pathology"
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "searchpathology"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command2_Click()
Adodc1.RecordSource = "Select * From pathology"
Adodc1.Refresh
End Sub
...
Adodc1.RecordSource = "Select * From pathology Where ID=" + Text1.Text + ""
Adodc1.Refresh
